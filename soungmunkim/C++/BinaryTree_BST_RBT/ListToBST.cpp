...
public:
    ...
    TreeNode* sortedListToBST(const std::vector<int>& nums) {
...
private:
    ...
    TreeNode* sortedListToBSTHelper(const std::vector<int>& nums, int start, int end) {
