...
(base) soungmunkim@gimseongmun-ui-MacBookPro String % g++ 14_LongestCommonPrefix_SM.cpp -o test           
...
// 가장 긴 공통 접두사를 찾는 함수
//  빈 문자열을 반환하는 부분의 반환 타입을 const char *로 변경
const char* longestCommonPrefix(char** strs) {// 수정: 반환 타입 변경 
    int strsSize = 0; 
